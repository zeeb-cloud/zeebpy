...
# Static checks (does it parse, does it import)
from zeeb_agents.checks import check_code

# Class-level surgery: one method, one attribute, one Meta key
from zeeb_agents.class_edit import set_class_attribute, set_class_method
...
# Custom logic generated by a FeatureSpec's `functions` block
from zeeb_agents.functions import delete_function, edit_function
...
__all__ = [
    ...
    # Standalone routes
    "create_route",
    # Custom logic (the FeatureSpec `functions` block)
    "delete_function",
    "edit_function",
    # Class-level surgery
    "set_class_method",
